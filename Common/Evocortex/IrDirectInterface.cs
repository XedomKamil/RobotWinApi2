...
namespace Common.irDirectBinding
{
    ...
    public class IrDirectInterface {
        ...
        public void daemon_launch()
        {
            CheckConnectionState();
            CheckResult(IrDirectInterfaceInvoke.evo_irimager_daemon_launch());
 
        }


        public void usb_init(string xml_config, string formats_def, string log_file)
        {
            CheckConnectionState();
            CheckResult(IrDirectInterfaceInvoke.evo_irimager_usb_init(xml_config, formats_def, log_file));
